const CACHE = 'agenthub-shell-v8';
const ASSETS = ['./', './index.html', './styles.css?v=20260905-4', './app.js?v=20260905-4', './cloud-connection.js?v=20260905-4', './manifest.webmanifest'];
