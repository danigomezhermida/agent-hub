const CACHE = 'agenthub-shell-v7';
const ASSETS = ['./', './index.html', './styles.css?v=20260904-9', './app.js?v=20260905-3', './cloud-connection.js?v=20260905-3', './manifest.webmanifest'];
